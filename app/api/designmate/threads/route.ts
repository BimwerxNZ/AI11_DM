...
import { designMateErrorResponse, DesignMateServiceError, listDesignMateThreadSummaries } from '~/modules/designmate/server/designmate.server';
...
export async function GET(request: Request) {
  try {
    ...
    const threads = await listDesignMateThreadSummaries();
